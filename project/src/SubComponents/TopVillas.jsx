...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
      These consequences follow, but to whom they are directed, so that their pain is minimal, and their pleasure is maximized. It involves a range of actions and outcomes, from providing various benefits to encountering difficulties. One must consider all aspects carefully.
      </p>
